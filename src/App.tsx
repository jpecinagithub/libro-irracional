        ...
        <section className="mx-auto max-w-6xl px-6">
          <div className="rounded-[24px] border border-slate-200 bg-slate-50 px-6 py-8 md:px-8">
            ...
            <p className="text-sm text-slate-600 mt-2 leading-relaxed max-w-3xl">
              Este libro no quiere darte respuestas prefabricadas, sino abrir una puerta. Si quieres seguir leyendo, descarga la introducción completa en PDF o escucha el audio. El resto —herida, Cruz, gracia, Resurrección— te espera en las páginas siguientes.
            </p>
            <div className="flex flex-wrap gap-3 mt-6">
              ...
              <a href="/intro.mp3" download className="rounded-full border border-slate-200 bg-white px-6 py-3 text-sm font-medium hover:bg-white">Descargar audio MP3</a>
            </div>
          </div>
        </section>
      </main>
